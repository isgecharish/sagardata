...
namespace PreOrderWorkflow
{
    public partial class ViewWorkflow : System.Web.UI.Page
    {
        ...
        protected void btnAttachment_Click(object sender, EventArgs e)
        {
            if (Request.QueryString["WFID"] != null)
            {
                string url = "http://192.9.200.146/Attachment/Attachment.aspx?AthHandle=J_PREORDER_WORKFLOW" + "&Index=" + Request.QueryString["WFID"] + "&AttachedBy=" + Request.QueryString["u"];
