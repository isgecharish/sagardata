<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestLogin.aspx.cs" Inherits="MobileTest.TestLogin" %>
...
<body>
   ...
   <div class="container">
        ...
        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator1" controltovalidate="txtUserName"
             errormessage="Please enter your Username!"  OnClick="btnEnter_Click" ForeColor="Red" Font-Size="12px">Please enter Username!</asp:RequiredFieldValidator>
            </div>
                </div>
    ...
    <label id="lblPassword"> Password </label>
         ...
         <asp:TextBox runat="server" CssClass="form-control" ID="txtPassword"  Enabled="true" CausesValidation="True"/>
              ...
              <asp:RequiredFieldValidator runat="server" id="reqPassword" controltovalidate="txtPassword" 
                  errormessage="Please enter your Password!" OnClick="btnEnter_Click" ForeColor="Red"  Font-Size="12px">Please enter Password!</asp:RequiredFieldValidator>
    </div>
            </div>
            </div>
        ...
        <div class="col-xs-8">
           <%-- <asp:Label runat="server" id="lblError" Visible="false" ForeColor="Red"></asp:Label>--%>
            <label  runat="server" id="lblError"  Visible="false" style="color:red; font-size:12px" >The Username and/ or Password you have entered is invalid !</label>
        </div>
