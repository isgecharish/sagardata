<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectProgressReport.aspx.cs" Inherits="MobileTest.ProjectProgressReport" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row text-center">
            <div class="col-sm-2"></div>
             <div class="col-sm-8">
        <div style="text-align: center; font-size: 14px; font-weight: bold"">
            <asp:Label id="lblSelectProject" runat="server" Visible="false" ForeColor="Black" Font-Bold="false" >Project&nbsp&nbsp</asp:Label>
             <asp:DropDownList runat="server" ID="ddlProject" Height="30" Width="150" autopostback="True" onselectedindexchanged="ddlProject_SelectedIndexChanged" Visible="false"></asp:DropDownList>
        </div>
                 </div>
                 <div class="col-sm-2"></div>
                 </div>
         <div class="row text-center">
               <div class="col-sm-2"></div>
               <div class="col-sm-8">
                   <asp:Label id="lblProjDetail" runat="server"   Visible="true" ForeColor="Black" Font-size="14px" Font-Bold="true" ></asp:Label>
               </div>
               <div class="col-sm-2"></div>
             </div>
        <br />
        ...
        <div class="container-fluid">
            <div class="row">
        <div class="col-xs-12" style="align-content:space-between"></div>
        <div class="container text-center" runat="server" id="mydiv" style="margin-left:0px">
        </div>
                </div>
            </div>
    </form>
