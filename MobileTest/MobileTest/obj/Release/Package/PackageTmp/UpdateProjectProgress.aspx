<%--<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="UpdateProjectProgress.aspx.cs" Inherits="MobileTest.UpdateProjectProgress" %>--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/mstInner.Master" AutoEventWireup="true" CodeBehind="UpdateProjectProgress.aspx.cs" Inherits="MobileTest.UpdateProjectProgress" %>
...
<div class="col-xs-9">
           ...
           <div class="container">
            ...
            <div class="col-xs-9">
                  <asp:TextBox runat="server" CssClass="form-control" ID="txtDescription"  Enabled="false" TextMode="MultiLine" />
                </div>
            </div>
            </div>
...
<div class="row" style="margin-top:10px">
   ...
   <%--<div style="font-size: 22px; font-weight: bold; margin-top: 20px; margin-left: 200px">
    ...
    <div class="container">
        <div class="row" style="margin-top:10px">    
    <div class="col-xs-12"; style="align-content:space-between"> 
       <%-- margin-left:25px; margin-right:35px;--%>
    <div class="table-responsive"; style="border: 1px solid;  overflow-x:hidden">
             <div class="row" style="margin-top:10px">
            <div class="col-xs-3">
...
<asp:FileUpload runat="server" ID="FileUpload" CssClass="form-control" AllowMultiple="true" BorderColor="White"/>
            ...
            <div class="col-xs-4">
                  <div style="margin-bottom:10px; margin-left:15px; margin-right:5px">
...
<asp:Button runat="server" ID="btnDeleteNotes" CssClass="btn" OnClick="btnDeleteNotes_Click" Text="Delete" Width="100" Visible="false" />
    ...
    <div class="col-xs-12" ;style="align-content:space-between"> 
                                <div class="table-responsive"; style="border:hidden;background-color:darkgray; overflow-x:hidden">       
